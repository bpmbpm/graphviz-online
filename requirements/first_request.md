...
Задачи:
1. произведи в https://github.com/bpmbpm/graphviz-online/tree/main/analysis анализ сервисов "graphviz online", которые одновременно могут передавать код dot параметром URL и отображать изображения через тег image=". 
2. в папке ver1 (https://github.com/bpmbpm/graphviz-online/tree/main/ver1) сохрани код в файле index.html, реализующий graphviz online, но при обеспечении условия, указанного выше (graphviz online + URL + image). Приведи тестовый пример (dot - код приведи в отдельном текстовом файле).  
