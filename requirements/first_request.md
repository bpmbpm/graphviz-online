...
2. в папке ver1 сохрани код, реализующий  graphviz online, но при обеспечении условия, указанного выше. Приведи тестовый пример (dot - код приведи в отдельном файле).  
Требования см. в
